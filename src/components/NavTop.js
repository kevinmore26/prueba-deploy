...
export default function NavTop( miBusqueda,{setmiBusqueda}) {
            ...
            <Form className="d-flex">
              <Navbar.Collapse id="basic-navbar-nav  " expand="lg">
                <Nav className="me-auto">
                  {user != null ? (
                    <Link
                      to={user.clienteTipo ==1 ? "/administrador" : "/pedidos"}
                      style={{
                        textDecoration: "none",
                        display: "flex",
                        alignItems: "center",
                    ...
                    >
                      ...
                      >
                        {user.clienteTipo ==1 ? "Administrador" : "Mis pedidos"}
                      </div>
                    </Link>
                  ) : (
                    <Link
                      ...
                      title={
                        <div className=" row d-inline text-black" >
                         ...
                         <Link
                          to="/iniciarSesion"
                          className="col-7"
                          style={{ color: "rgb(106, 105, 110)", textDecoration: "none",position:"relative",bottom:"2px" }}
                        >
                          Iniciar Sesión
                        </Link>
                        </div>
                  ...
                  {user != null && (
                    ...
                    >
                      <NavDropdown.Item
                        className="text-rgb(106, 105, 110)"
                        onClick={Out}
                        style={{ color: "rgb(106, 105, 110) !important" }}
                      >
                        Cerrar Sesión
                      </NavDropdown.Item>
                    </NavDropdown>
                      ...
                      title={
                        ...
                        >
                          <img
                            ...
                            alt="avatar"
                          />
                          <span style={{ color: "rgb(106, 105, 110)", marginTop: "10px" }}>
