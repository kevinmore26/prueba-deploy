...
export default function ProductosFiltroView() {
  ...
  const getProductos = async () => {
    ...
    const productosFiltrados2 = await obtenerProductosFiltro(miBusqueda);
    ...
    if (
      ...
      searchAlbums();
      const productosFiltrados = await obtenerProductosFiltro(miBusqueda);
      setProductos(productosFiltrados);
      setAuthPending(false);
    } else {
      searchAlbums();
                      ...
                      title={
                        ...
                        >
                          <img
                            ...
                            alt="avatar"
                          />
                          <span color="black"  style={{ color: "rgb(106, 105, 110) !important", marginTop: "10px" }}>
