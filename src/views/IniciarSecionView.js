        ...
        <div >
          ...
          >
            <h1 className="text-center">
              <span className="font-weight-bold text-white">Inicia Sesión </span>
            </h1>
            <FormGroup className="text-left" style={{width:"25vw",margin:"0 auto"}}>
              <label style={{color:"white",fontWeight:"bold",textAlign:"left !important",width:"25vw !important"}}>Email</label>
              <br />
              <input
            ...
            >
                <label style={{color:"white",fontWeight:"bold",textAlign:"left !important",width:"25vw !important"}}>Contraseña</label>
